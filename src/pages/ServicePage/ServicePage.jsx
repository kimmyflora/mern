...
export default function ServicePage({ loggedUser, handleLogout }) {
                ...
                <Grid.Row>
                    <Grid.Column style={{ maxWidth: 450 }}>
                        {loading ? <h1>Loading.....</h1> :
                         <PostFeed  posts={posts.filter(post => post.businessType === 'Services')} // Filter posts based on business type
